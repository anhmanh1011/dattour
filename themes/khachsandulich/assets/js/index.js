...
//     $('.cart_top_ajax').click(function(event){
//       event.stopPropagation();
//     });
...
$(window).on("load resize" , function(){
      if($(window).outerWidth() < 768 ){
        ...
        // $('.click_colapse').click(function(event){
        //     $('.open_colapse').removeClass('active_colapse');
        //     event.stopPropagation();
        //     $(this).next().toggleClass('active_colapse');

        // });

        // $('.open_colapse').click(function(event){
        //      event.stopPropagation();
        // });

        // $('body').click(function(){
        //         if($('.open_colapse').hasClass('active_colapse')){
        //             $('.open_colapse').removeClass('active_colapse');
        //         }

        //     });

        var acc = document.getElementsByClassName("click_colapse");
            var i;

            for (i = 0; i < acc.length; i++) {
                acc[i].addEventListener("click", function() {
                    this.classList.toggle("active");
                    var open_colapse = this.nextElementSibling;
                    if (open_colapse.style.display === "block") {
                        open_colapse.style.display = "none";
                    } else {
                        open_colapse.style.display = "block";
                    }
                });
            }
