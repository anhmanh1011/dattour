...
class Souvenir extends Model
{
     ...
     */
    public $table = 'web_hotel_souvenir';
    public $belongsTo = [
        'location' => ['Web\Hotel\Models\Location'],
    ];
    public $belongsToMany = [
        'types' =>[
            'Web\Hotel\Models\SouvenirType',
            'table' => 'web_hotel_relation_souvenir_type',
            'order' => 'name'
        ],
        'tags' =>[
            'Web\Hotel\Models\Tag',
            'table' => 'web_hotel_relation_tag_souvenir',
            'order' => 'name'
        ],
    ];
