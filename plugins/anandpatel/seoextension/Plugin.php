...
class Plugin extends PluginBase
{
    ...
    public function registerSettings()
    {
        return [
            'settings' => [
                ...
                'order'       => 100,
                'permissions' => ['anandpatel.seoextension.settings']
            ]
        ];
    ...
    {
        return [
            'anandpatel.seoextension.settings' => [
                'label' => 'anandpatel.seoextension::lang.settings.description',
                'tab' => 'anandpatel.seoextension::lang.settings.label',
                'order' => 200,
            ]
        ];
    }
    ...
    public function register()
    {
        ...
        \Event::listen('backend.form.extendFields', function($widget)
        {
            ...
            if(PluginManager::instance()->hasPlugin('RainLab.Blog') && $widget->model instanceof \RainLab\Blog\Models\Post)
            {
             ...
             if(PluginManager::instance()->hasPlugin('Web.Hotel') && $widget->model instanceof \web\hotel\Models\hotel)
            {
                $widget->addFields([
                        'seo_title' => [
                            'label'   => 'Meta Title',
            ...
            if(PluginManager::instance()->hasPlugin('Web.Hotel') && $widget->model instanceof \web\hotel\Models\room)
            {
                $widget->addFields([
                        'seo_title' => [
                            'label'   => 'Meta Title',
             ...
             if(PluginManager::instance()->hasPlugin('Web.Hotel') && $widget->model instanceof \web\hotel\Models\souvenir)
            {
                $widget->addFields([
                        'seo_title' => [
                            'label'   => 'Meta Title',
             ...
             if(PluginManager::instance()->hasPlugin('Web.Hotel') && $widget->model instanceof \web\hotel\Models\event)
            {
                $widget->addFields([
                        'seo_title' => [
                            'label'   => 'Meta Title',
             ...
             if(PluginManager::instance()->hasPlugin('Web.Hotel') && $widget->model instanceof \web\hotel\Models\foodbeverage)
            {
                $widget->addFields([
                        'seo_title' => [
                            'label'   => 'Meta Title',
